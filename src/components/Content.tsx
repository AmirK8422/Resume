...
type Project = {
  title: string;
  description: string;
  status: "Ongoing" | "Unpublished" | "Published";
  link?: string;
};
...
const projects: Project[] = [
  {
    title: "Zi-Home",
    description: "A website for online household items",
    status: "Unpublished",
  },
  {
    title: "Hotel Mojan",
    description: "Frontend almost complete. Backend still under development.",
    status: "Ongoing",
  },
  {
    title: "NikeK",
    description: "Modern online shoe shop concept with nightwing theme.",
    status: "Published",
    link: "https://nike-k.vercel.app",
  },
];
  ...
  return (
    <main className="flex-1 p-4 md:p-8">
      ...
      <Section title="Education">
        <Item
          title="Student of Computer Engineering"
...
function Section({
  ...
  return (
    <motion.section
      ...
      className="mb-8">
      <h2 className="text-primary text-lg md:text-xl font-semibold border-b border-slate-800 pb-1 mb-3">
        {title}
      </h2>
      {children}
    </motion.section>
